...
- [[Concept] Simple translational dynamics with ray-casting [MC 1.10.X]](https://youtu.be/ljm0Aj3G7qo) - (just for the archive) The old legend when Minecraft doesn't have built-in ray tracing method. By using boat to achieve it and some examples to utilize the technique.
